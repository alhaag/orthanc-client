...
const Patients = {
        ...
        return new Promise((resolve, reject) => {
            request({
                ...
                .parse((res)=>{
                    ...
                    res.on('end', () => resolve(Buffer.concat(buffer))); // TODO: testing and return length
                })
                .catch(reject);
            /*request
                .get({
    ...
    getModule: function(client, id, simplify) {
        return new Promise((resolve, reject) => {
            const aditionalParam = (simplify === true) ? {simplify: ''} : {}
            request({
                url: client.url + '/patients/' + id + '/module',
                headers: client.headers,
                params: Object.assign(client.params, aditionalParam),
                auth: client.auth
            })
                .then(res => resolve(res.body))
                .catch(reject);
    ...
    getSharedTags: function(client, id, simplify) {
        return new Promise((resolve, reject) => {
            const aditionalParam = (simplify === true) ? {simplify: ''} : {}
            request({
                url: client.url + '/patients/' + id + '/shared-tags',
                headers: client.headers,
                params: Object.assign(client.params, aditionalParam),
                auth: client.auth
            })
